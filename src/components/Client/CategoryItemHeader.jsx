function CategoryItemHeader() {
	return (
		<div className="group rounded-md shadow-xl p-[5px] h-[70px] flex items-center hover:cursor-pointer hover:shadow-[0_0px_2px_0_#003cbf,0_0px_6px_0px_#003cbf]">
			...
			<span className="line-clamp-2 text-black text-sm ml-2">
