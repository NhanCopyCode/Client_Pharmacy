...
function Detail({ model }) {
	...
	const { name, src, image, approved } = data;
	...
	return (
		<>
			...
			<div className="grid grid-cols-12 gap-3 p-3 text-sm">
				...
				<div className="col-span-3 font-semibold">Tên video:</div>
				<div className="col-span-9">{name || "Không có"}</div>

				<div className="col-span-3 font-semibold">Ảnh thumbnail:</div>
				...
				<div className="col-span-3 font-semibold">Video:</div>
				<div className="col-span-9">
					{src.includes("youtube.com") || src.includes("youtu.be") ? (
						<iframe
							...
							className="w-full max-w-xl aspect-video rounded border"
							frameBorder="0"
