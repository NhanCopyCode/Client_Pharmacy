	...
	return (
		<>
			...
			<div className="grid grid-cols-12 gap-3 p-3 text-sm">
				...
				<div className="col-span-3 font-semibold">Mã code:</div>
				<div className="col-span-9">{code}</div>
				...
				<div className="col-span-3 font-semibold">Số lượt sử dụng:</div>
				<div className="col-span-9">
				...
				<div className="col-span-9">
					{usage_limit_per_user || "Không giới hạn"}
				</div>
